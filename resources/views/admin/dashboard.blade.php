                ...
                <div class="card">
                    <div class="row">
                        <div class="col">
                            ...
                            @if (!$etkinlik->isonay)
                            <a type="button" href="{{ route('eventonay', $etkinlik->id) }}" class="btn btn-success">Onayla</a>
                            @endif

                            <a type="button" href="{{ route('etkinliksil', $etkinlik->id) }}" class="btn btn-danger">Sil</a>
